...
def k_nearest_neighbor_train(df):
    ...
    # Convert the regression problem into a classification problem by creating bins
    num_bins = 5
    df['Corners_Class'] = pd.qcut(df['Team Av Corners'], q=num_bins, labels=False)

    # Use 'Corners_Class' as the target variable
    y = df['Corners_Class']
